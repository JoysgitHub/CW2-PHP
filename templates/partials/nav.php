...
<div id="main-nav" class="flex justify-between items-center py-4 border-b border-gray-200 dark:bg-gray-900">
	<div class="pl-4 ">   
	<a href="index.php">
        <img src="/CW2-PHP/img/logo_uni.png" class="w-12 h-12" alt="Image">
	</a>
		</div>
